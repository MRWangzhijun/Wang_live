...
public class Home_ChioncenessAdapter extends SimpleAdapter<Liveing.ResultBean.ListBean> {



    public Home_ChioncenessAdapter(Context context, List<Liveing.ResultBean.ListBean> datas) {
