...
import com.wzj.live.other.SoftKeyBoardListener;
import com.wzj.live.utils.DisplayUtil;
...
public class Fragment_Three extends Fragment implements View.OnClickListener {
    ...
    private HeartLayout three_fragment_hear;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        three_fragment_hear = (HeartLayout) view.findViewById(R.id.three_fragment_hear);
        ...
        three_fragment_hear.setOnClickListener(this);
    ...
    public  void showGift(String tag) {
        ...
        if (giftView == null) {/*该用户不在礼物显示列表*/
            ...
            if (llgiftcontent.getChildCount() > 2) {/*如果正在显示的礼物的个数超过两个，那么就移除最后一次更新时间比较长的*/
                ...
                com.wzj.live.other.CustomRoundView picTv1 = (CustomRoundView) giftView1.findViewById(R.id.crvheadimage);
    ...
    private void getLove(){
        three_fragment_hear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                three_fragment_hear.addHeart(Color.GRAY);
                three_fragment_hear.addHeart(Color.BLUE);
                three_fragment_hear.addHeart(Color.CYAN);
                three_fragment_hear.addHeart(Color.RED);
                three_fragment_hear.addHeart(Color.GRAY);
            }
        });
